...
class WIW_Dataset(Dataset):
    def __init__(self, root, feats=None, lng_dict=None, split="train"):
        self.root = root
        self.resources = [("https://mega.nz/#!eV0STDTR!w6Xg248RQdzL28VOmoqsFLidJqrlSZKx7f8AGqfA204", "wiw_data.zip")]
        # Dataset parameters
        if lng_dict is None:
            lng_dict = {
                "eng": "english",
    ...
    def download(self) -> None:
        ...
        # download files
        for url, filename in self.resources:
...
for languages in [("eng", "ger"), ("eng", "it"), ("eng", "ru")]:
    ...
    lng1, lng2 = languages
    dataset_name = (
        "C:/Users/chapm/PycharmProjects/PartialBarlowTwins"
        "/data/wiw_data/"
        + lng1
        + "_"
        + lng2
